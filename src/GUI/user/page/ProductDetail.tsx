...
const ProductDetail = () => {
    ...
    const [productWithTheSameCategory, setProductWithTheSameCategory] = useState<Product[]>([]);
                    ...
                    <div className="col-lg-8 col-xl-9">
                        <div className="row g-4">
                            ...
                            <div className="col-lg-6">
                                ...
                                <h5 className="fw-bold mb-3">{loading ? <Skeleton width={100} /> : formatCurrency(product?.price || 0)}</h5>
                                ...
                                <a onClick={() => handleAddToCart(product?.id ?? 0, quantity)} href="#" className="btn border border-secondary rounded-pill px-4 py-2 mb-4 text-primary">
                            ...
                            <div className="col-lg-12">
                                ...
                                <div className="tab-content mb-5">
                                    <div className="tab-pane active" id="nav-about" role="tabpanel" aria-labelledby="nav-about-tab">
                                        <p className="mb-4">{loading ? <Skeleton width={900} count={10} /> : product?.description}</p>The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.
