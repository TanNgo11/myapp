...
import { Product, ProductTable, ProductType, UpdateProductRequest } from '../../../models/Product';
    ...
    return (
        ...
        >
            ...
            <div className="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <Button variant="danger" onClick={handleDeleteSelectedProducts} style={{ marginRight: "10px", fontWeight: 400 }}>
                        Delete Selected
                    </Button>
                    <Button
                        variant="info"
