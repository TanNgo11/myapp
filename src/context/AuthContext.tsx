...
export const AuthProvider = ({ children }: AuthProviderProps) => {
    ...
    const refreshToken = async () => {
        ...
        try {
            const response = await axiosInstance.post('/api/v1/auth/refresh', { token: refreshTokenState });
    ...
    return (
        <AuthContext.Provider value={{ user, role, login, logout, loading, refreshToken }}>
            {children}
